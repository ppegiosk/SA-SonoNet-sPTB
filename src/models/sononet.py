# Extracted from https://github.com/rdroste/SonoNet_PyTorch
...
class SonoNet(nn.Module):
    ...
    def __init__(self, config, num_labels=6, in_channels=1, 
                 weights=False, softmax=False, features_only=False):
        super().__init__()
        self.config = config
            ...
            if weights:
                if not isinstance(weights, str):
                    weights = os.path.join(
                        os.path.dirname(__file__) + '/weights/sononet',
